...
async function main() {
  ...
  console.log("\n✅ Document-type seed complete!");
  console.log("   Created: 12 listings, 5 team members, 5 testimonials, 10 FAQs, 5 coverage areas, 4 company stats, 4 company values, 3 value propositions");
}
